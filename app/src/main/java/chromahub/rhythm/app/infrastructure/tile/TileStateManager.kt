 ...
 * No Android imports - testable and platform-agnostic.
 * 
...
class TileStateManager {
    ...
    companion object {
         ...
         * Clean, professional labels without emojis.
         */
    ...
    fun getTileState(): TileState {
        ...
        val routingSubtitle = getRoutingName(currentRouting).takeIf { it.isNotEmpty() }
